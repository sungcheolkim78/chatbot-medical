...
<div align="center">
<img src="docs/figs/medical_chatbot.png" alt="Medical Chatbot Architecture" height="400px" style="box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
...
<img src="docs/figs/chatbot_langchain_screenshot.png" style="box-shadow: 0 4px 8px rgba(0,0,0,0.2);">

Dataset Viewer 
- The dataset viewer to validate the evaluation dataset with the source excerpts
<img src="docs/figs/eval_app_screenshot.png" style="box-shadow: 0 4px 8px rgba(0,0,0,0.2);">

Chatbot Score Viewer 
- The chatbot response viewer with LLM Judge score
<img src="docs/figs/eval_score_screenshot.png" style="box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
